...
<table>
  <tr>
    <td style="vertical-align: middle;">
      - 🎨 Focused on <strong>Front-end Development</strong> with modern web technologies.<br>
      - ⚛️ Currently studying <strong>React</strong> and <strong>Node.js</strong> to build full-stack applications.<br>
      - 🐍 Learning <strong>Python for AI</strong> for academic projects.<br>
      - ☕ Background in <strong>Java</strong> and <strong>Spring</strong> for back-end support.<br>
      - 🧠 Improving my <strong>soft skills</strong> through training programs at <strong>RocketSeat 🚀</strong>.<br>
...
<p>
  ...
  <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/junit/junit-original.svg" height="40"/>
</p>
